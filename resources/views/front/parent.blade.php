...
<head>
    ...
    <!-- fonts -->
    <link rel="stylesheet"
        href="{{ asset('front/https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,700,700i') }}">
    <!-- css -->
...
<body>
                ...
                <ul class="mobile-links mobile-links--level--0" data-collapse
                    ...
                    <li class="mobile-links__item" data-collapse-item>
                        <div class="mobile-links__item-title">
                            <a href="{{ route('front.home') }}" class="mobile-links__item-link">Home</a>
                    ...
                    <li class="mobile-links__item" data-collapse-item>
                        ...
                        <div class="mobile-links__item-sub-links" data-collapse-content>
                            <ul class="mobile-links mobile-links--level--1">
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('blog-classic.html') }}"
                                            class="mobile-links__item-link">Blog Classic</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('blog-grid.html') }}"
                                            class="mobile-links__item-link">Blog Grid</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('blog-list.html') }}"
                                            class="mobile-links__item-link">Blog List</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a
                                            href="{{ asset('blog-left-sidebar.html') }}"
                                            class="mobile-links__item-link">Blog Left Sidebar</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('post.html') }}"
                                            class="mobile-links__item-link">Post Page</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a
                                            href="{{ asset('post-without-sidebar.html') }}"
                    ...
                    <li class="mobile-links__item" data-collapse-item>
                        ...
                        <div class="mobile-links__item-sub-links" data-collapse-content>
                            <ul class="mobile-links mobile-links--level--1">
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('about-us.html') }}"
                                            class="mobile-links__item-link">About Us</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('contact-us.html') }}"
                                            class="mobile-links__item-link">Contact Us</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a
                                            href="{{ asset('contact-us-alt.html') }}"
                                            class="mobile-links__item-link">Contact Us Alt</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('404.html') }}"
                                            class="mobile-links__item-link">404</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a
                                            href="{{ asset('terms-and-conditions.html') }}"
                                            class="mobile-links__item-link">Terms And Conditions</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('faq.html') }}"
                                            class="mobile-links__item-link">FAQ</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('components.html') }}"
                                            class="mobile-links__item-link">Components</a></div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title"><a href="{{ asset('typography.html') }}"
    ...
    <div class="site">
                ...
                <div class="mobile-header__panel">
                    <div class="container">
                        <div class="mobile-header__body">
                            ...
                            <a class="mobile-header__logo" href="{{ asset('index.html') }}">
                            ...
                            <div class="mobile-header__indicators">
                                ...
                                <div class="indicator indicator--mobile">
                                    <a href="{{ asset('cart.html') }}" class="indicator__button">
                                        <span class="indicator__area">
                                            <svg width="20px" height="20px">
                                                                ...
                                                                <ul class="megamenu__links megamenu__links--level--0">
                                                                    <li
                                                                        ...
                                                                        <ul
                                                                            ...
                                                                            <li class="megamenu__item"><a href="#">
                                                                                </a>
                                                                            </li>
                                                                    ...
                                                                    <li class="megamenu__item"><a href="#">Presses</a>
                                                                    </li>
                                                                    <li class="megamenu__item"><a href="#">Spray
                                                                            Guns</a></li>
                                                                    <li class="megamenu__item"><a href="#">Riveters</a>
                                                                    </li>
                                                                </ul>
                                                                {{-- @endforeach --}}
                                                            </div>
                                ...
                                <div class="nav-panel__nav-links nav-links">
                                    <ul class="nav-links__list">
                                        <li class="nav-links__item"><a
                                                href="{{ route('front.home') }}"><span>Home</span></a>
                                        </li>
                                        ...
                                        {{-- <li class="nav-links__item nav-links__item--with-submenu">
                                        <a href="#">
                                            <span>Contact Us<svg class="nav-links__arrow" width="9px" height="6px">
                                                    <use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use>
                                                </svg>
                                            </span>
                                        </a>
                                        ...
                                        <li class="nav-links__item"><a href="{{ route('front.books') }}"><span>
                                                    Book</span></a>
                                            {{-- <li class="nav-links__item nav-links__item--with-submenu">
                                            ...
                                            {{-- <li><a href="{{ route('front.books') }}">Book List</a></li> --}}
                                            ...
                                            {{-- <li>
                                                    ...
                                                    <div class="menu__submenu">
                                                        <!-- .menu -->
                                                        <ul class="menu menu--layout--classic">
                                                            <li><a href="{{ route('front.books') }}">Book</a></li>
                                                            <li><a href="product-sidebar.html">Book Sidebar</a></li>
                                                        </ul>
                                                        <!-- .menu / end -->
                                                    </div>
                                                </li>
                                    ...
                                    <!-- .menu / end -->
                                        ...
                                        <li class="nav-links__item"><a href="#"><span>About Us</span></a>
                                            {{-- <li class="nav-links__item nav-links__item--with-submenu">
                                        <a href="#">
                                            <span>
                                              About Us
                                        ...
                                        <li class="nav-links__item"><a href="{{ route('front.logout') }}"><span>
                                                    Logout</span></a>
                                    </ul>
                                </div>
                                <!-- .nav-links / end -->
                                <div class="nav-panel__indicators">
                                    <div class="indicator">
                                        <a href="{{ route('WishList') }}" class="indicator__button">
                                            <span class="indicator__area">
                                                <svg width="20px" height="20px">
                                                    <use
                                                        xlink:href="{{ asset('front/images/sprite.svg#heart-20') }}">
                                                    </use>
                                                </svg>
                                                <span class="indicator__value">0</span>
                                            </span>
                                    ...
                                    <div class="indicator indicator--trigger--click">
                                        <a href="{{ route('front.cart') }}" class="indicator__button">
                                            <span class="indicator__area">
                                                <svg width="20px" height="20px">
                                                    <use xlink:href="{{ asset('front/images/sprite.svg#cart-20') }}">
                                                    </use>
                                                </svg>
                                                <span class="indicator__value">3</span>
                                            </span>
        ...
        <footer class="site__footer">
            <div class="site-footer">
                <div class="container">
                            ...
                            <div class="col-12 col-md-12 col-lg-4">
                                <div class="site-footer__widget footer-newsletter">
                                    ...
                                    <div class="footer-newsletter__text">Praesent pellentesque volutpat ex, vitae
                                        auctor lorem pulvinar mollis felis at lacinia.</div>
                    ...
                    <div class="site-footer__bottom">
                        ...
                        <div class="site-footer__payments"><img src="{{ asset('front/images/payments.png') }}"
                                alt="">
                        </div>
                    </div>
                </div>
            ...
            <!-- js -->
            <script src="{{ asset('front/vendor/jquery-3.3.1/jquery.min.js') }}"></script>
            <script src="{{ asset('front/vendor/bootstrap-4.2.1/js/bootstrap.bundle.min.js') }}"></script>
            <script src="{{ asset('front/vendor/owl-carousel-2.3.4/owl.carousel.min.js') }}"></script>
            <script src="{{ asset('front/vendor/nouislider-12.1.0/nouislider.min.js') }}"></script>
            <script src="{{ asset('front/js/number.js') }}"></script>
            <script src="{{ asset('front/js/main.js') }}"></script>
            <script src="{{ asset('front/vendor/svg4everybody-2.1.9/svg4everybody.min.js') }}"></script>
            <script>
                svg4everybody();
            </script><!-- font - fontawesome -->
            <link rel="stylesheet" href="{{ asset('front/vendor/fontawesome-5.6.1/css/all.min.css') }}">
            <link rel="stylesheet" href="{{ asset('front/fonts/stroyka/stroyka.css') }}">
