                                                    ...
                                                    <div class="filter-list">
                                                        <div class="filter-list__list">
                                                            <label class="filter-list__item">
                                                                ...
                                                                <span class="filter-list__title">Wakita </span><span
                                                                    class="filter-list__counter">7</span>
                                                            </label>
                                                            <label class="filter-list__item">
                                                                <span class="filter-list__input input-check">
                                                                    <span class="input-check__body">
                                                                ...
                                                                <span class="filter-list__title">Zosch </span><span
                                                                    class="filter-list__counter">42</span>
                                                            </label>
                                                            ...
                                                            <label class="filter-list__item">
                                                                ...
                                                                <span class="filter-list__title">Mitasia </span><span
                                                                    class="filter-list__counter">1</span>
                                                            </label>
                                                            <label class="filter-list__item">
                                                                <span class="filter-list__input input-check">
                                                                    <span class="input-check__body">
                                                                ...
                                                                <span class="filter-list__title">Metaggo </span><span
                                                                    class="filter-list__counter">25</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="filter-color__list">
                                                            <label class="filter-color__item">
                                                                <span
                                                                    ...
                                                                    style="color: #fff;">
                                                                    <label class="input-check-color__body"><input
                            ...
                            {{-- <div class="widget-products widget">
                                ...
                                <div class="widget-products__list">
                                    ...
                                    <div class="widget-products__item">
                                        ...
                                        <div class="widget-products__info">
                                            <div class="widget-products__name"><a href="product.html">Undefined Tool IRadix
                                    ...
                                    <div class="widget-products__item">
                                        ...
                                        <div class="widget-products__info">
                                            <div class="widget-products__name"><a href="product.html">Brandix Router Power
                        ...
                        <div class="products-view">
                            <div class="products-view__options">
                                <div class="view-options">
                                    ...
                                    <div class="view-options__legend">Showing 6 of 98 books</div>
                                ...
                                <div class="products-list__body">
                                    ...
                                    {{-- <div class="products-list__item">
                                        <div class="product-card">
                                            ...
                                            <div class="product-card__image"><a href="product.html"><img src="" alt=""></a>
                                            </div>
                                            <div class="product-card__info">
                                    ...
                                    @foreach ($books as $book)
                                        <div class="products-list__item">
                                            <div class="product-card ">
                                                ...
                                                <div class="product-card__image"><a href="#"><img
                                                            src="{{ url(Storage::url($book->image)) }}" alt=""></a></div>
                                                <div class="product-card__info">
                                                    <div class="product-card__name"><a href="#">{{ $book->name }}</a>
                                                    </div>
                                                    <div class="product-card__rating">
                                                        <div class="rating">
                                                            <div class="rating__body">
                                        ...
                                        <div class="product-card">
                                            ...
                                            <div class="product-card__info">
                                                <div class="product-card__name"><a href="product.html">Brandix
                                                        Angle Grinder KZX3890PQW</a></div>
                                                <div class="product-card__rating">
                                                    <div class="rating">
                                                        <div class="rating__body">
                                                            <svg class="rating__star rating__star--active" width="13px"
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__buttons">
                                                <button class="btn btn-primary product-card__addtocart" type="button">Add
