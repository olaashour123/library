                        ...
                        <div class="block-products__featured-item">
                            @foreach ($books as $book)
                                <div class="product-card">
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__name"><a href="product.html">{{ $book->name }}
                                            </a></div>
                                        <div class="product-card__rating">
                                            <div class="rating">
                                                <div class="rating__body">
                        ...
                        <div class="block-products__list-item">
                            <div class="product-card">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            src="images/products/product-2.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__name"><a href="product.html">Undefined Tool IRadix DPS3000SY
                                            2700 Watts</a></div>
                                    <div class="product-card__rating">
                                        <div class="rating">
                                            <div class="rating__body">
                                ...
                                <div class="block-products-carousel__cell">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card__actions">
                                            <div class="product-card__availability">Availability: <span
                                                    class="text-success">In Stock</span></div>
                                            <div class="product-card__prices">${{ $book->price }}
                                                <div class="product-card__buttons">
